...
def calibrate_from_images_using_undistortion(images, rows=12, cols=12):
    ...
    if objpoints:
        ...
        np.savez('calib_npz_undistort.npz', mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)
        ...
        x, y, w, h = roi
        cropped_undistorted = undistorted[y:y+h, x:x+w]
        ...
        return {
            ...
            "undistorted_cropped": cropped_undistorted,
            "calibration_file": "calib_npz_undistort is saved"
        }
